...
Recently, I posted my slides [here](https://kaijagahm.netlify.app/projects/2021-07-13-retroactivelyreproducible/) after converting them to a blog post/text format. Converting the slides to a blog post wasn't as easy as I had hoped. In this article, I'll describe how I did it.
...
My goal was to present each slide, followed by a block of text, essentially transcribing what I said during the presentation. 
